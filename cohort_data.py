...
def sort_by_cohort(filename):
    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            entry = line.split("|")
            if entry[-1] == 'Winter 2016':
                winter_16.append(entry[0]+" "+entry[1])
            elif entry[-1] == 'Spring 2016':
                spring_16.append(entry[0]+" "+entry[1])
            elif entry[-1] == 'Summer 2016':
                summer_16.append(entry[0]+" "+entry[1])
            elif entry[-1] == 'Fall 2015':
                fall_15.append(entry[0]+" "+entry[1])
            elif entry[-1] == 'G':
                ghosts.append(entry[0]+" "+entry[1])
    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            if entry[2] == 'Gryffindor':
                gryffindor.append(entry[1])
            elif entry[2] == 'Hufflepuff':
                hufflepuff.append(entry[1])
            elif entry[2] == 'Slytherin':
                slytherin.append(entry[1])
            elif entry[2] == "Dumbledore's Army":
                dumbledores_army.append(entry[1])
            elif entry[-1] == 'G':
                ghosts.append(entry[1])
            elif entry[-1] == 'I':
                instructors.append(entry[1])
